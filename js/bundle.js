...
(function () {
  ...
  const translations = {
    es: {
      appTitle: "MSG Viewer",
      openMsg: "Abrir correo (.msg, .eml)",
      openFolder: "Abrir carpeta",
      printPdf: "Imprimir / PDF",
      printPdfTitle: "Imprimir correo o guardar como PDF",
      searchPlaceholder: "Buscar por asunto o remitente...",
      dropTitle: "Selecciona o arrastra un correo (.msg, .eml) o carpeta",
      dropDesc:
        "Haz clic en los botones o arrastra archivos de correo (.msg, .eml) o carpetas completas desde tu equipo para abrirlos de forma instantánea.",
      exploreFiles: "Explorar archivos",
      dropOverlayTitle: "Suelta los archivos de correo (.msg, .eml) o carpetas aquí",
      ...
      selectMsgAlert:
        "No se encontraron archivos de correo (.msg, .eml) en la selección.",
      ...
      aboutDesc:
        "Visor gratuito, offline y seguro de archivos de correo (.msg, .eml) para Windows",
      ...
      deleteMsgFileTitle: "Enviar este archivo a la papelera de reciclaje",
      deleteMsgConfirm:
    ...
    en: {
      appTitle: "MSG Viewer",
      openMsg: "Open Email (.msg, .eml)",
      openFolder: "Open folder",
      printPdf: "Print / PDF",
      printPdfTitle: "Print email or save as PDF",
      searchPlaceholder: "Search by subject or sender...",
      dropTitle: "Select or drag an email (.msg, .eml) or folder",
      dropDesc:
        "Click the buttons or drag email files (.msg, .eml) or entire folders from your computer to open them instantly.",
      exploreFiles: "Browse files",
      dropOverlayTitle: "Drop email files (.msg, .eml) or folders here",
      ...
      selectMsgAlert: "No email files (.msg, .eml) were found in the selection.",
      readErrorAlert: "Could not read file",
      aboutTitle: "About MSG Viewer",
      aboutCreator: "Created by:",
      aboutContact: "Contact:",
      aboutRepo: "Repository (GitHub):",
      aboutDesc: "Free, offline and secure email viewer (.msg, .eml) for Windows",
      ...
      deleteMsgFileTitle: "Move this email file to Recycle Bin",
      deleteMsgConfirm:
    ...
    fr: {
      appTitle: "MSG Viewer",
      openMsg: "Ouvrir un e-mail (.msg, .eml)",
      ...
      dropTitle: "Sélectionnez ou glissez un e-mail (.msg, .eml) ou un dossier",
      dropDesc:
        "Cliquez sur les boutons ou glissez des fichiers d'e-mails (.msg, .eml) ou des dossiers complets depuis votre ordinateur pour les ouvrir instantanément.",
      exploreFiles: "Parcourir les fichiers",
      dropOverlayTitle: "Déposez les fichiers d'e-mails (.msg, .eml) ou dossiers ici",
      ...
      selectMsgAlert:
        "Aucun fichier d'e-mail (.msg, .eml) n'a été trouvé dans la sélection.",
      ...
      aboutDesc:
        "Visionneuse gratuite, hors ligne et sécurisée de fichiers d'e-mails (.msg, .eml) pour Windows",
      ...
      deleteMsgFileTitle: "Déplacer ce fichier d'e-mail vers la corbeille",
      deleteMsgConfirm:
    ...
    pt: {
      appTitle: "MSG Viewer",
      openMsg: "Abrir e-mail (.msg, .eml)",
      openFolder: "Abrir pasta",
      printPdf: "Imprimir / PDF",
      printPdfTitle: "Imprimir e-mail ou salvar como PDF",
      searchPlaceholder: "Pesquisar por assunto ou remetente...",
      dropTitle: "Selecione ou arraste um e-mail (.msg, .eml) ou pasta",
      dropDesc:
        "Clique nos botões ou arraste arquivos de e-mail (.msg, .eml) ou pastas inteiras do seu computador para abri-los instantaneamente.",
      exploreFiles: "Procurar arquivos",
      dropOverlayTitle: "Solte os arquivos de e-mail (.msg, .eml) ou pastas aqui",
      ...
      selectMsgAlert:
        "Nenhum arquivo de e-mail (.msg, .eml) foi encontrado na seleção.",
      ...
      aboutDesc:
        "Visualizador gratuito, offline e seguro de arquivos de e-mail (.msg, .eml) para Windows",
      ...
      deleteMsgFileTitle: "Mover este arquivo de e-mail para a lixeira",
      deleteMsgConfirm:
  ...
  // 6. EML (RFC 822 / MIME) Parser Class
  class EmlParser {
    constructor(data) {
  ...
  // 7. IndexedDB Storage Manager for Persistent Opened Messages
  class MsgStorage {
  ...
  class MsgViewerApp {
    ...
    async handleDirectoryPicker() {
      try {
        ...
        this.handleFilesSelected(emailFiles);
      } catch (err) {
          ...
          if (!parsedData) {
            ...
            if (isEml) {
              ...
              try {
                ...
                // Fallback to EmlParser if MsgParser fails
                const parser = new EmlParser(arrayBuffer);
                parsedData = parser.parse();
              }
            }
